...
const SearchBox = () => {
    return (
        ...
        <form className="max-w-md mx-auto w-full">
            <label htmlFor="default-search" className="mb-2 text-sm font-medium sr-only e">Search</label>
            <div className="relative">
                ...
                <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm " placeholder="Search Projects...." required />
